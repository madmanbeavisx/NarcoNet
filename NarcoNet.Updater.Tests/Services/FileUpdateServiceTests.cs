...
public class FileUpdateServiceTests : IDisposable
{
    ...
    {
        // Act
        Action act = () => new FileUpdateService(null!, _updateStagingDirectory, _removedFilesManifestPath, _testDirectory, Path.Combine(_testDirectory, "UpdateManifest.json"), Path.Combine(_testDirectory, "PreviousSync.json"));
    ...
    {
        // Act
        Action act = () => new FileUpdateService(_logger, null!, _removedFilesManifestPath, _testDirectory, Path.Combine(_testDirectory, "UpdateManifest.json"), Path.Combine(_testDirectory, "PreviousSync.json"));
    ...
    {
        // Act
        Action act = () => new FileUpdateService(_logger, _updateStagingDirectory, null!, _testDirectory, Path.Combine(_testDirectory, "UpdateManifest.json"), Path.Combine(_testDirectory, "PreviousSync.json"));
    ...
    {
        // Act
        Action act = () => new FileUpdateService(_logger, _updateStagingDirectory, _removedFilesManifestPath, null!, Path.Combine(_testDirectory, "UpdateManifest.json"), Path.Combine(_testDirectory, "PreviousSync.json"));
    ...
    {
        // Arrange
        FileUpdateService service = new(_logger, _updateStagingDirectory, _removedFilesManifestPath, _testDirectory, Path.Combine(_testDirectory, "UpdateManifest.json"), Path.Combine(_testDirectory, "PreviousSync.json"));
